...
xdescribe '#countdown_with_sleep' do
    it 'should take at least 5 seconds to execute' do	    it 'should take at least 5 seconds to execute' do
      runtime = Benchmark.measure { countdown_with_sleep(5) }	      runtime = Benchmark.measure { countdown_with_sleep(5) }
      expect(runtime.real.to_i >= 5).to be true	      expect(runtime.real.to_i >= 5).to be true